...
public class OrderController {
  ...
  public int checkoutUsers(@RequestBody String jsonOrders)
    ...
    //  System.out.println("ans:"+object.toString());

      list.add(gson.fromJson(object.toString(), Order.class)); // creates an object
    }
    //System.out.println(list); // stores format of Order.java
